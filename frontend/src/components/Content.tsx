        ...
        >
          <div className='connectionstatus__container'>
            <span className='h6 px-1'>
              {tr('ui.neo4jConnection')} {isReadOnlyUser ? tr('ui.readOnlyMode') : ''}
            </span>
                ...
                <div>
                  {hasSelections ? (
                    <span className='n-body-small'>
                      {hasSelections} {tr('ui.graphSchemaConfigured')}
                      {hasSelections
                        ? tr('ui.graphSchemaConfiguredCount', {
                            labels: selectedNodes.length,
                            rels: selectedRels.length,
                          })
                        : ''}
                    </span>
                  ) : (
                    <span className='n-body-small'>{tr('ui.noGraphSchemaConfigured')}</span>
                  )}
                </div>
              </div>
            </Typography>
          ...
          <div className='enhancement-btn__wrapper'>
            <ButtonWithToolTip
              ...
              text={
                !isAuthenticated && !SKIP_AUTH
                  ? tr('ui.pleaseLogInFirst')
                  : !connectionStatus
                    ? tr('ui.pleaseConnectToNeo4j')
                    : tr('ui.enhanceGraphQuality')
              }
              label={tr('ui.graphEnhancementSettings')}
              className='mr-2!'
            ...
            {!connectionStatus ? (
              <SpotlightTarget id='connectbutton' hasPulse={!connectDisabled} indicatorVariant='border'>
                <ButtonWithToolTip
                  text={connectDisabled ? tr('ui.pleaseLoginFirstToConnect') : buttonCaptions.connectToNeo4j}
