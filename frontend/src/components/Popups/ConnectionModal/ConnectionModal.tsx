...
export default function ConnectionModal({
  ...
  return (
    <>
      ...
      >
        <Dialog.Header htmlAttributes={{ id: 'form-dialog-title' }}>{tr('ui.connectToNeo4jTitle')}</Dialog.Header>
        <Dialog.Content className='n-flex n-flex-col n-gap-token-4'>
          <Typography variant='body-medium' className='mb-4'>
            <TextLink type='external' href='https://console.neo4j.io/'>
              {tr('ui.noNeo4jInstance')}
            </TextLink>
          </Typography>
