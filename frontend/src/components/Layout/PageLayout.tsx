...
const buildSpotlightsForUnauthenticated = () => [
  {
    target: 'loginbutton',
    children: (
      <>
        <Spotlight.Header>{tr('tour.loginHeader')}</Spotlight.Header>
        <Spotlight.Body>{tr('tour.loginBody')}</Spotlight.Body>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.connectHeader')}</Spotlight.Header>
        <Spotlight.Body>{tr('tour.connectBody')}</Spotlight.Body>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.uploadHeader')}</Spotlight.Header>
        <Spotlight.Body>{tr('tour.uploadBody')}</Spotlight.Body>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.llmHeader')}</Spotlight.Header>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.generateHeader')}</Spotlight.Header>
        <Spotlight.Body>{tr('tour.generateBody')}</Spotlight.Body>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.visualizeHeader')}</Spotlight.Header>
        <Spotlight.Body>{tr('tour.visualizeBody')}</Spotlight.Body>
      </>
    ),
  },
  {
    ...
    children: (
      <>
        <Spotlight.Header>{tr('tour.chatHeader')}</Spotlight.Header>
      </>
    ),
  },
];
const buildSpotlights = () => [
  {
    target: 'connectbutton',
    children: (
      <>
  ...
  return (
    <>
      {!isAuthenticated && !SKIP_AUTH && isFirstTimeUser ? (
        <SpotlightTour
          spotlights={buildSpotlightsForUnauthenticated()}
